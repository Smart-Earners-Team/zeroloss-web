(function ($) {
    ...
    function csselem() {
        $(".height-emulator").css({height: jQuery(".footer--fixed").outerHeight(true)});
    }
    ...
    lightBox();
    $('.carosuel-slider--v1').slick({slidesToShow: 1, arrows: false, dots: true, speed: 800, pauseOnDotsHover: true});
    ...
    $('.carosuel-slider--v3').slick({
        ...
        responsive: [{breakpoint: 768, settings: {slidesToShow: 1,}}, {breakpoint: 1200, settings: {slidesToShow: 2,}},]
    });
