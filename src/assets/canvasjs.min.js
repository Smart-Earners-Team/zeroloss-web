...
(function () {
  ...
  //             (k.height - 14) +
  //             "px;color:dimwhite;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"
  //         ),
  ...
  var Ja = !1,
    ...
    ra = {
      ...
      Toolbar: {
        ...
        publicProperties: { options: "readWrite", chart: "readWrite" },
      },
      Legend: {
        name: null,
      ...
      Crosshair: {
        ...
        labelWrap: !0,
        labelMaxWidth: null,
        labelBackgroundColor: r ? "white" : null,
        labelBorderColor: r ? "white" : null,
        labelBorderThickness: 0,
        labelCornerRadius: 0,
        labelFontFamily: r
  ...
  Na.Chart = (function () {
    ...
    function p(a, d) {
      ...
      if (
        ...
        this.canvas.getContext &&
          ...
          (this._preRenderCtx.textBaseline = "none"),
    ...
    $.prototype._initialize = function () {
      if (this.enabled) {
        ...
        this.container.style.boxShadow = "10px 10px 2px 2px rgba(1,200,55,0.1)";
