...
function Roadmap(props) {
    return (
                                ...
                                <div className="row">
                                    <div className="col-12 col-md-10 mx-auto reveal">
                                        <div className="testimonials__pattern background-holder background--auto background--top--left opacity--40">
                                            <img src="images/layout/vertical-pattern-1.png" alt="wave" className="background-image-holder" />
                                        </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            <div className="d-flex flex-column">
                                                                <span className="client-name font-size--17 font-w--600"><img src="images/Medium.svg" style={{width: "120px"}} /></span>
                            ...
                            <div className="container mt-5">
                                <div className="row">
                                    <div className="col-12">
                                        <div className="newsletter-form form--v3 position-relative d-lg-flex align-items-center rounded--10 py-4 p-lg-4 p-xl-7" style={{backgroundColor: "black"}}>
                                            ...
                                            <div className="col-12 col-md-10 col-lg-2 mx-md-auto text-right">
                                                <a href="https://zeroloss.fund/" target="_blank" className="btn btn-hover--splash" type="submit" style={{backgroundColor: "gold"}}><span className="btn__text">GO! <i className="icon icon-arrow-right"></i></span></a>
        ...
        </section><section className="space--bottom bg-color--primary-light--1 ">
                <div className="container">
