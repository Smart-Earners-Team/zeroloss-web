            ...
            <div className="row flex-column-reverse flex-lg-row align-items-center text-center">
              <div className="col-12 col-md-10 col-lg-6 text-lg-left">
                ...
                <p className="opacity--70" style={{ color: "white" }}>
                  ...
                  Proactive Market Making (PMM) algorithm.it was developed
                  entirely in-house by the DODO team and is an elegant, on-chain
                  generalization of orderbook trading.It is adapted and
                  optimized for operations on the blockchain and has proven
                  itself to be highly performant and capital-efficient (as its
                  high volume/TVL ratio can attest) with many innovative,
                  flexible use cases in market making with very reduced risk.
                  <br />
                  <br />
                  ZLT is a great asset to earn value on your long term
                  stablecoins, BTC, ETH, BNB and and other crypto holdings, all
                  interoperable, unstoppable and onchain through our PMM stake
                  pool! There's a time lock on the zeroloss utility contract,
                  IDO and other Defi Blue Chips, which makes ZLT sustainable.
                  <br />
                  <br />
              ...
              <div className="col-12 col-lg-6 mt-5 mt-lg-0 mb-3 mb-lg-0 pl-lg-10
            ...
            >
              <div className="card border--none bg-white text-center box-shadow--4 py-4 px-2 d-flex align-items-center card-hover--shadow-3d">
                ...
                <p className="font-size--16">
                  ...
                  ever seen in Defi's future advancements DeFi2.0.
                </p>
              </div>
            </Animatedcontainer>
            <Animatedcontainer
